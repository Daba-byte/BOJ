...
tetromino_shapes = [
    ...
    [(0, 1), (1, 1), (2, 1), (2, 0)],  # 반전된 L 모양
    [(0, 0), (0, 1), (0, 2), (1, 0)],  # 눕힌 L 모양
    [(0, 0), (0, 1), (0, 2), (1, 2)],  # 반전된 눕힌 L 모양
    [(0, 0), (1, 0), (2, 0), (0, 1)],  # 세로로 돌린 L 모양
    [(0, 0), (1, 0), (1, 1), (1, 2)],  # 반전된 세로로 돌린 L 모양

    # Z자 모양 (Z자)
    [(0, 0), (0, 1), (1, 1), (1, 2)],  # Z 모양
    [(0, 1), (1, 0), (1, 1), (2, 0)],  # 반전된 Z 모양
    [(0, 0), (1, 0), (1, 1), (2, 1)],  # 세로로 돌린 Z 모양
    [(1, 0), (1, 1), (0, 1), (0, 2)],  # 반전된 세로로 돌린 Z 모양
